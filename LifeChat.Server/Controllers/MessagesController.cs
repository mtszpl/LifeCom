...
namespace LifeChat.Server.Controllers
{
    ...
    public class MessagesController : Controller
    {
        ...
        [HttpGet]
        [Route("/read")]
        [Filters.CustomFilterTest]
        public async Task<List<Message>> ReadChatMessages(int chatId)
        {
            var identity = HttpContext.User.Identity as ClaimsIdentity;


            List<Message> filteredMesages = _context.Message.Where(msg => msg.chatId == chatId).ToList();
